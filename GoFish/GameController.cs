...
namespace GoFish
{
    public class GameController
    {
        ...
        {
            IEnumerable<Player> computerPlayersWithCards = Opponents.Where(player => player.Hand.Count() > 0);
            do
            {
        ...
        public void NewGame()
        {
            ...
            gameState = new GameState(gameState.HumanPlayer.Name, gameState.Opponents.Select(player => player.Name),
                new Deck().Shuffle());
        }
    }
}
